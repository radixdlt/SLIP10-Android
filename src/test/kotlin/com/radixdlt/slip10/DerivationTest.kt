...
class DerivationTest {
    ...
    fun generateKeysFromSeed() {
        testData.forEach {
            ...
            val parsedPrv = XPriv(it.expectedPrivateKey).toExtendedKey(EllipticCurveType.Secp256k1)
            assertThat(derivedKey).isEqualTo(parsedPrv)

            val parsedTestnetPrv = XPriv(it.expectedTestnetPrivateKey).toExtendedKey(EllipticCurveType.Secp256k1)
